...
REALIZAR AJUSTES DO LIVE UPDATE:

1 - BAIXA OS LOGS
2 - BAIXA O APP DO LIVE UPDATE(https://versao.tasken.com/live_update_executavel.zip) ENTRA COM A CONTA DO WEBDESK
3 - VERIFICA O ID NO LOG E REALIZA O AJUSTE
