BACKUP DATABASE [CORPORERM] TO DISK = N'\\192.168.9.146\srv-arch03$\SVR-BD05\CORPORERM_2025_ABRIL_V2.BAK' WITH NOFORMAT, INIT,  NAME = N'CORPORERM-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
GO
...
RESTORE VERIFYONLY FROM  DISK = N'\\192.168.9.146\srv-arch03$\SVR-BD05\CORPORERM_2025_ABRIL_V2.BAK' WITH FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
