...
UPDATE C
  SET C.COD_MATRIZ_CONTABIL =
     CASE WHEN A.MATRIZ = 'FABULA - MATRIZ'       THEN '805005'
           WHEN A.MATRIZ = 'CD CAROL BASSI - ZZAB' THEN '560029'
      ELSE A.MATRIZ END  
FROM FILIAIS A
JOIN PROP_FILIAIS B ON A.FILIAL = B.FILIAL AND B.PROPRIEDADE = '01126'
JOIN CTB_FILIAL_RATEIO C ON A.COD_FILIAL = C.RATEIO_FILIAL
WHERE   B.VALOR_PROPRIEDADE  = 'COMERCIAL'
    AND A.MATRIZ <> CASE 
                WHEN A.MATRIZ = 'FABULA - MATRIZ'       THEN '805005'
                WHEN A.MATRIZ = 'CD CAROL BASSI - ZZAB' THEN '560029'
              ELSE A.MATRIZ END              
-- PRIMEIRO STEP 1 --
...
UPDATE C
  SET C.COD_MATRIZ_CONTABIL =  
      CASE WHEN A.MATRIZ = 'FABULA FILIAL PA'         THEN '805002'
           WHEN A.MATRIZ = 'CAROL BASSI REGULADOR RJ' THEN '560000'
      ELSE A.MATRIZ END  
FROM FILIAIS A
JOIN PROP_FILIAIS B ON A.FILIAL = B.FILIAL AND B.PROPRIEDADE = '01126'
JOIN CTB_FILIAL_RATEIO C ON A.COD_FILIAL = C.RATEIO_FILIAL
WHERE B.VALOR_PROPRIEDADE  = 'COMERCIAL'
AND A.MATRIZ <> CASE WHEN A.MATRIZ = 'FABULA FILIAL PA'         THEN '805002'
               WHEN A.MATRIZ = 'CAROL BASSI REGULADOR RJ' THEN '560000'
          ELSE A.MATRIZ END          
-- ULTIMO STEP  --
